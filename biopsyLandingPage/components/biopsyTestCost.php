...
<div class="biopsy-test-cost">
 <table class="biopsy-test-cost__table" cellspacing="0" cellpadding="">

 <tr>
    <th>Biopsy Type</th>
    <th>Approximate Test Cost</th>
 </tr>
 <tr>
...
<button><a href="#" style="text-decoration:none; color:white ">Get FREE Cost Estimation</a></button>
</div>
</div>
</section>